...
const getAllinscripciones = async (req, res) =>{
    try{
        ...
        const allInscripciones = inscripciones.map(
            ({id, tipo_de_evento, idEvento, fecha_del_evento, horarios, nombre, apellido, edad, altura, peso, escuela, profesor, graduacion_actual, proxima_graduacion, imagen, estado, eliminado})=>
            ({id, tipo_de_evento, idEvento, fecha_del_evento, horarios, nombre, apellido, edad, altura, peso, escuela, profesor, graduacion_actual, proxima_graduacion, imagen, estado, eliminado})
        )
