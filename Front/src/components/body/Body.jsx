    ...
    <div className="bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 py-16 px-6">
        {items.map((item, index) => (
          <div
            key={index}
            className="relative bg-white border border-gray-200 rounded-2xl shadow-md p-6 text-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl"
          >
            <h2 className="text-2xl font-bold text-emerald-600 mb-4">{item.title}</h2>
      ...
      <div className="bg-white py-16 px-6 mt-12 shadow-inner">
        <h2 className="text-4xl font-bold text-center text-gray-800 mb-12 underline underline-offset-8">
          Escuelas asociadas
        </h2>
      ...
      {/* Qué es el Taekwondo */}
      <div className="max-w-5xl mx-auto py-16 px-6 bg-white mt-12 rounded-2xl border border-gray-200 shadow-md">
        <h1 className="text-3xl font-bold text-center text-blue-600 mb-6">¿Qué es el Taekwondo?</h1>
        ...
        <ul className="list-disc list-inside text-gray-700 mb-6 ml-4 sm:ml-12">
        ...
        <h2 className="text-2xl font-semibold text-center text-blue-500 mb-4">Beneficios del Taekwondo</h2>
        <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4 sm:ml-12">
      ...
      <div className="flex justify-center mt-10 mb-16">
        <button className="px-8 py-4 text-lg font-semibold text-white bg-green-500 rounded-xl shadow-lg transition duration-300 hover:bg-green-600 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2">
          ¡Quiero inscribirme!
        </button>
      </div>
    </div>
