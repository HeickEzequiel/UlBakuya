...
function Body() {
  ...
  return (
    <div className="text-zinc-950 bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-cyan-100 via-white to-cyan-100 py-16 px-6 mt-12 shadow-inner">
      ...
      <div className="max-w-5xl mx-auto py-16 px-6 bg-transparent mt-12 rounded-2xl border-4 border-zinc-700 shadow-md">
        <h1 className="text-3xl font-bold text-center text-lime-400 mb-6">¿Qué es el Taekwondo?</h1>
        ...
        <ul className="list-disc list-inside text-white mb-6 ml-4 sm:ml-12">
        ...
        <h2 className="text-2xl font-semibold text-center text-lime-400 mb-4">Beneficios del Taekwondo</h2>
        <ul className="list-disc list-inside text-white space-y-2 ml-4 sm:ml-12">
