        ...
        <div>
          <h2 className='text-white text-left mr-4 my-1 mx-2'>Seguinos en nuestras redes</h2>
            <div className="flex absolute gap-1">
              <AdvancedImage cldImg={instagram} className='size-8 rounded-lg ml-2' />
              <AdvancedImage cldImg={facebook} className='size-8 rounded-lg ml-2'/>
              <AdvancedImage cldImg={tiktok} className='size-8 rounded-lg ml-2'/>
              <AdvancedImage cldImg={x} className='size-8 rounded-lg ml-2'/>
            </div>
        </div>
