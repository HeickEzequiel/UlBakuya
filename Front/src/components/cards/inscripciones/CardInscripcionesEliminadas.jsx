  ...
  <table className="w-full border-collapse border border-gray-300 shadow-md rounded-md overflow-hidden">
    <tbody>
      <tr className="even:bg-gray-100 hover:bg-gray-200 transition-colors">
        ...
        <td className="px-4 py-2 w-44 border border-gray-300 text-sm">{props.horaio}</td>
        ...
        <td className="px-4 py-2 w-44 border border-gray-300 text-sm">{props.edad}</td>
        <td className="px-4 py-2 w-44 border border-gray-300 text-sm">{props.altura}</td>
        <td className="px-4 py-2 w-44 border border-gray-300 text-sm">{props.peso}</td>
        <td className="px-4 py-2 w-44 border border-gray-300 text-sm">{props.escuela}</td>
        <td className="px-4 py-2 w-44 border border-gray-300 text-sm">{props.graduacion_actual}</td>
        <td className="px-4 py-2 w-44 border border-gray-300 text-sm">{props.proxima_graduacion}</td>
        <td className="px-4 py-2 w-44 border border-gray-300 text-sm">{props.imagen}</td>
